...
import 'package:flutter/cupertino.dart' hide CupertinoTextSelectionToolbar;
...
import 'text_selection_toolbar.dart' as custom;
import 'text_selection_toolbar_button.dart' as custom;

// Read off from the output on iOS 12. This color does not vary with the
// application's theme color.
const double _kSelectionHandleOverlap = 1.5;
// Extracted from https://developer.apple.com/design/resources/.
const double _kSelectionHandleRadius = 8;
...
class CupertinoTextSelectionControls extends TextSelectionControls with HaloTextSelectionControls {
  HandleCopy? hookHandleCopy;

  CupertinoTextSelectionControls(this.hookHandleCopy);
  @override
  ...
  Widget buildToolbar(
    ...
    return _CupertinoTextSelectionControlsToolbar(
      ...
      handleSelect: (delegate is HaloTextSelectionDelegate)? (canSelect(delegate as HaloTextSelectionDelegate) ? () => handleSelect(delegate as HaloTextSelectionDelegate): null):null,
  ...
  void handleCopy(TextSelectionDelegate delegate) {
    if (hookHandleCopy != null) {
      hookHandleCopy!.call(delegate);
    } else {
...
final TextSelectionControls cupertinoTextSelectionHandleControls = CupertinoTextSelectionHandleControls();

/// Text selection controls that follow iOS design conventions.
final TextSelectionControls cupertinoTextSelectionControls = CupertinoTextSelectionControls(null);
...
class _CupertinoTextSelectionControlsToolbarState extends State<_CupertinoTextSelectionControlsToolbar> {
  ...
  Widget build(BuildContext context) {
    ...
    void addToolbarButton(
      ...
      items.add(custom.CupertinoTextSelectionToolbarButton.text(
        onPressed: onPressed,
        text: text,
      ));
    }
    ...
    if (widget.handleSelect != null) {
      addToolbarButton(toolBarSelectLabel, widget.handleSelect!);
    }
    ...
    return custom.CupertinoTextSelectionToolbar(
