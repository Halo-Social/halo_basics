...
import 'text_selection_toolbar_text_button.dart' as android;
import 'text_selection_toolbar.dart' as android;
...
class MaterialTextSelectionControls extends TextSelectionControls with HaloTextSelectionControls {

  HandleCopy? hookHandleCopy;

  MaterialTextSelectionControls(this.hookHandleCopy);
  ...
  Widget build(BuildContext context) {
    ...
    final List<_TextSelectionToolbarItemData> itemDatas = <_TextSelectionToolbarItemData>[
      ...
      if (widget.handleSelect != null)
        _TextSelectionToolbarItemData(
          label: toolBarSelectLabel,
          onPressed: widget.handleSelect!,
        ),
    ...
    return android.TextSelectionToolbar(
      anchorAbove: anchorAbove,
      anchorBelow: anchorBelow,
      children: itemDatas.asMap().entries.map((MapEntry<int, _TextSelectionToolbarItemData> entry) {
        return android.TextSelectionToolbarTextButton(
          padding: android.TextSelectionToolbarTextButton.getPadding(entry.key, itemDatas.length),
          onPressed: entry.value.onPressed,
          child: HText(entry.value.label, style: HTextStyle.cellOutRegular.tcPrimary),
        );
      }).toList(),
    );
  }
...
final TextSelectionControls materialTextSelectionControls = MaterialTextSelectionControls(null);
